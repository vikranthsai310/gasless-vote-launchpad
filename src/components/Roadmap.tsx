...
const Roadmap = () => {
  return (
    <section id="roadmap" className="py-16 bg-gray-50" data-animation-type="fade-in">
      <div className="container mx-auto px-4 md:px-6">
        <div className="max-w-3xl mx-auto mb-16 text-center" data-animation-type="fade-up">
          <h2 className="text-3xl md:text-4xl font-bold mb-4" data-animation-type="fade-up">Roadmap</h2>
          <p className="text-lg text-gray-600" data-animation-type="fade-up">
            Our journey to revolutionize decentralized voting
          </p>
        </div>
        
        <div className="max-w-4xl mx-auto" data-animation-type="fade-up">
          <div className="relative">
            {/* Animated timeline line */}
            <div className="absolute left-4 md:left-1/2 transform md:-translate-x-1/2 h-full w-0.5" data-animation-type="fade-in">
            ...
            <div className="space-y-16">
              {/* Phase 1 */}
              <div className="relative flex flex-col md:flex-row md:items-center gap-8" data-animation-type="fade-up">
                <div className="md:w-1/2 md:text-right md:pr-12 order-2 md:order-1" data-animation-type="slide-right">
                  ...
                  <ul className="space-y-3">
                    <li className="flex items-center md:justify-end gap-2" data-animation-type="fade-up">
                ...
                <div className="absolute left-0 md:left-1/2 transform md:-translate-x-1/2 flex items-center justify-center" data-animation-type="zoom-in">
                  <div className="w-8 h-8 rounded-full border-4 border-purple-600 bg-white"></div>
                </div>
                <div className="md:w-1/2 md:pl-12 order-1 md:order-2 ml-12 md:ml-0" data-animation-type="slide-left">
              ...
              <div className="relative flex flex-col md:flex-row md:items-center gap-8" data-animation-type="fade-up">
                <div className="md:w-1/2 order-2 md:order-1 md:pr-12" data-animation-type="slide-right">
                  <div className="bg-white p-5 rounded-lg shadow-md border border-purple-100">
                    <p className="text-sm text-gray-600">
              ...
              <div className="relative flex flex-col md:flex-row md:items-center gap-8" data-animation-type="fade-up">
                <div className="md:w-1/2 md:text-right md:pr-12 order-2 md:order-1" data-animation-type="slide-right">
                  ...
                  <ul className="space-y-3" data-stagger>
                    <li className="flex items-center md:justify-end gap-2" data-staggered data-animation-type="fade-right">
